...
export type BlockTypes = | SectionBlockData | ParagraphBlockData | CalloutBlockData | ImageBlockData | ScriptBlockData | SceneBlockData | DialogueBlockData

export const blocksRegistry = {
  section: {
  } as SectionBlockData,
  paragraph: {
  } as ParagraphBlockData,
  callout: {
  } as CalloutBlockData,
  image: {
  } as ImageBlockData,
